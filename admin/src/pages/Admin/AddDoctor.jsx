...
const [docImg,setdocImg]=useState(null)
   ...
   async function onSubmitHandler(event){
    ...
    try{
        ...
        console.error(error); // Add this to see the actual error in console
    ...
    <form onSubmit={onSubmitHandler} className='m-6 w-full'> 
        ...
        <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
            ...
            <div>
                ...
                <textarea onChange={(e)=>setAbout(e.target.value)} value={about}  className='w-full px-4 pt-2 border rounded' required placeholder='write about doctor' rows={5}/>

            </div>
            <button type='submit' className='bg-purple-800 px-10 py-3 mt-4 cursor-pointer text-white rounded-full'>Add doctor</button>
        </div>
    </form>
  )
}
