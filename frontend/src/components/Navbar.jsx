  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-300'>
        ...
        <div className='flex items-center gap-10'>
            { // token=> if its true it means you are logged in else display create button to create a new account
                token && userData ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                  <img className='w-8 rounded-full' src={userData.image}  alt="user picture"/>
              ...
              <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                ...
                :
                <button onClick={()=>navigate('/login')} className='cursor-pointer bg-purple-800 text-white px-8 py-3 rounded-full font-light hidden md:block'>Create Account</button>
